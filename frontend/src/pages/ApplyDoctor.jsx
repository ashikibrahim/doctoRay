// import { Upload, Icon, TimePicker, Button, Col, Form, Input, Row } from "antd";
...
function ApplyDoctor() {
  ...
  const handleSubmit=async(e)=>{
    ...
    formdata.append("timingsFrom",e.target.timingsFrom.value)
    formdata.append("timingsTo",e.target.timingsTo.value)
    ...
    try {
      ...
      const response = await axios.post(
        "/api/users/apply-doctor-account",formdata,
        {
          headers: {
          ...
          <form onSubmit={handleSubmit} allign="center">
            ...
            <Card>
              ...
              <FormControl fullWidth sx={{ m: 1, width: '70ch', ml: 45 }}>
                  ...
                  <OutlinedInput id="outlined-adornment-amount" label="firstName"type='text' name='firstName' />
                </FormControl>
                <FormControl fullWidth sx={{ m: 1, width: '70ch', ml: 45 }}>
                  <InputLabel htmlFor="outlined-adornment-amount">Last Name</InputLabel>               
                  <OutlinedInput id="outlined-adornment-amount" label="lastName"type='text' name='lastName' />
                </FormControl>
                <FormControl fullWidth sx={{ m: 1, width: '70ch', ml: 45 }}>
                  <InputLabel htmlFor="outlined-adornment-amount">Phone Number</InputLabel>               
                  <OutlinedInput id="outlined-adornment-amount" label="phoneNumber"type='text' name='phoneNumber' />
                </FormControl>
                <FormControl fullWidth sx={{ m: 1, width: '70ch', ml: 45 }}>
                  <InputLabel htmlFor="outlined-adornment-amount">Address</InputLabel>               
                  <OutlinedInput id="outlined-adornment-amount" label="address"type='text' name='address' />
                </FormControl>
                <FormControl fullWidth sx={{ m: 1, width: '70ch', ml: 45 }}>
                ...
                <FormControl fullWidth sx={{ m: 1, width: "70ch", ml: 45 }}>
                  <InputLabel htmlFor="outlined-adornment-amount">consult start</InputLabel>
                <OutlinedInput
              ...
              <FormControl fullWidth sx={{ m: 1, width: "70ch", ml: 45 }}>
                  <InputLabel htmlFor="outlined-adornment-amount">consult end</InputLabel>
                <OutlinedInput
                  id="outlined-adornment-amount"
                  label="feePerConsultation"
                  type="time"
                ...
                {/* <FormControl fullWidth sx={{ m: 1, width: '70ch', ml: 45 }}>
                  <InputLabel htmlFor="outlined-adornment-amount">To Time</InputLabel>
                  <OutlinedInput id="outlined-adornment-amount"  type="time" label="timings" name='timingsTo' />
                </FormControl> */}
